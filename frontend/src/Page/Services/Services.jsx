  ...
  return (
    <div className="container mx-auto px-4 py-32 max-w-7xl">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600">혁신적인 기술로 비즈니스의 성공을 지원합니다.</p>
      </div>
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold text-gray-800 mb-8">왜 우리를 선택해야 할까요?</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="text-xl font-semibold text-gray-800 mb-2">10년+ 경험</h3>
            <p className="text-gray-600">다양한 산업 분야의 프로젝트 경험</p>
          </div>
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="text-xl font-semibold text-gray-800 mb-2">전문가 팀</h3>
            <p className="text-gray-600">숙련된 개발자와 컨설턴트로 구성</p>
          </div>
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="text-xl font-semibold text-gray-800 mb-2">24/7 지원</h3>
      ...
      <div className="mt-32">
        <h2 className="text-3xl font-bold text-gray-800 mb-12 text-center">프로젝트 진행 프로세스</h2>
      ...
      <div className="mt-32 bg-blue-600 rounded-2xl p-12 text-center text-white">
        ...
        <p className="text-xl mb-8">전문가와 상담하고 최적의 솔루션을 찾아보세요.</p>
